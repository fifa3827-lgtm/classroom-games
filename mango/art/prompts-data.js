...
/* ───────────────────────── 5. 단서 아이콘 ───────────────────────── */
{
  ...
  items: [
    ...
    { file:"clue-strap.png", label:"뒷문의 크림색 끈",
      p:"A cream-coloured fabric apron tie-string snagged on the outer EDGE of a heavy door — caught on the edge itself, NOT on a handle (this door has no outer handle) — the loose end hanging down. "+STYLE.icon },
